...
def get_room_details(booking_reference):
    try:
        lambda_url = 'https://jyy44z44clmckyfxkrduth5qke0ouado.lambda-url.us-east-1.on.aws/'
...
def forward_to_agent(property_info):
    ...
    try:
        ...
        response = get_room_details(property_info['booking_reference'])['body']
